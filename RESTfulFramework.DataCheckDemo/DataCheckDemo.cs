...
namespace RESTfulFramework.DataCheckDemo
{
    ...
    {
        public bool CheckSign(object body, string token, string api, string remark, string sign, string timestamp)
        {
            ...
            return sign == Common.Tool.GetMd5(token + api + remark + timestamp + systemSecretKey, Encoding.UTF8);
        }
