var TestSqlite = (function () {
    function TestSqlite() {
    }
    TestSqlite.prototype.Test = function () {
        ...
        db.switchTable('channel_list').insertData([{ name: 'aa', link: 'ss', updatetime: new Date().getTime() }, { name: 'bb', link: 'kk', updatetime: new Date().getTime() }], function () {
        });
