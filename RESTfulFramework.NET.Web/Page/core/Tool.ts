class Tool {
     ...
     */
    public formatDate(datetime, format): string {
     ...
     * @param o 对像
     */
    public isArray(o: any): boolean { return Object.prototype.toString.call(o) === '[object Array]'; }

    /**
     * 获取url指定参数的值
     * @param url url地址
     */
    public GetRequest(url: string): Array<any> {
        var strs = [];
        var theRequest = [];
        if (url.indexOf("?") != -1) {
