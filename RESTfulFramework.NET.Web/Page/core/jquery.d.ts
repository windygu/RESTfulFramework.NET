...
interface JQueryXHR extends XMLHttpRequest, JQueryPromise<any> {
     ...
     */
    error(error: (xhr: JQueryXHR, textStatus: string, errorThrown: string) => any): JQueryXHR;
    complete(complete: (xhr: JQueryXHR, textStatus: string, errorThrown: string) => any): JQueryXHR;
}
