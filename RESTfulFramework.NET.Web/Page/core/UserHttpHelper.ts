...
class UserHttpHelper extends HttpHelper {
     ...
     */
    public Login(userName: string, password: string, result: any, error: any): void {
        var err = error;
     ...
     * @param error 请求过程中产生的错误回调
     */
    public Register(userName: string, password: string, smscode: string,realname, result: any, error: any): void {
        var err = error;
     ...
     * @param error 请求过程中产生的错误回调
     */
    public SendSmsCode(phone: string, result: any, error: any): void {
        var err = error;
     ...
     * @param error 请求过程中产生的错误回调
     */
    public GetUserInfo(result: any, error: any): void {
       var err = error;
