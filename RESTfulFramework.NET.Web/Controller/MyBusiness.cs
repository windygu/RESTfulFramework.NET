...
namespace RESTfulFramework.NET.Web.Controller
{
    ...
    public class MyBusiness : Controller<ConfigManager, ConfigModel, TableUserCache<ConfigManager, ConfigModel>, UserInfo, JsonSerialzer, DBHelper, SmsManager, LogManager>
    {
